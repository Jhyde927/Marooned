...
// // --------- New tint uniforms ----------
// uniform vec3  u_tint;            // group tint color (e.g. vec3(1,0,0))
// uniform float u_tintStrength;    // 0..1 (0 = no tint, 1 = full tint)
// // -------------------------------------
...
//     vec3 tintedCol = col * u_tint;                 // e.g. tint = (1,0,0) makes it red
//     col = mix(col, tintedCol, u_tintStrength);

//     //col = mix(col, u_tint, u_tintStrength);
//     // ----------------------
